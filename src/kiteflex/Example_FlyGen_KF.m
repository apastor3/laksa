...
if Validation_Type == 3
   ...
   % [rQ rR_Edge R_KE rR vR omegaR FA_R QR rK vK omegaK FA_K MA_K MMC_K alfa_K beta_K QK rG vG omegaG FA_G MA_G MMC_G QG DF RHS]=  Fun_ODE_Lag_Full_Output_KF(0,u0,PND);
    
     
    display('Integrating Equations of motion')
    [T X] = ode45('Fun_ODE_Lag_KF',[0:0.01:1],u0);
    
    DF = Fun_ODE_Lag_KF(0,u0)
