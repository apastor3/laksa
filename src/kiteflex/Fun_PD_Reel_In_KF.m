...
PD.Tether.ro   = 0;%1e-6;           % Tether density (kg/m^3)
PD.Tether.dt   = 2e-3;          % Tether diameter (m)
PD.Tether.Cd   = 0.0;           % Tether Cd  
...
PD.Aero.Clbeta =  1.24;          % Cl_beta                      (-)       % Williams
...
PD.Aero.Cnbeta =  0.78;         % Cn_beta                      (-)       % Williams
...
PD.Bridle.delta = 5*pi/180;%-PD.Aero.Cm0/PD.Aero.Cmalfa+1*pi/180;      % delta                              (rad)
...
% Control parameters
PD.Control.Type      = 4;         % See Fun_Control  
                                 
PD.Control.T0        = 20;        % Control period 

PD.Control.eps_lt    = -0.13;     % lt = lt0*(1+eps_lt*sin(ome_lt*t)) or % lt = lt0*(1+eps_lt*t)  
...
PD.Num.N       = 1;              % Number of bars
PD.Num.IntTol  = 1e-10;           % Integrator Tolerance
